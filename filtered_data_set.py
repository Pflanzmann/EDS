...
def getNonUs():
    data = pd.read_csv('csvs/datensatz-Stichprobe.csv')
    data2 = pd.read_csv('csvs/salaries.with_salaries_only.csv')
    ...
    merged_df.to_csv('csvs/merged_file.csv', index=False)

    return pd.read_csv('csvs/merged_file.csv')


def getUs():
    data = pd.read_csv('csvs/salaries.csv')
    return data


def us_filtered_data():
    data = getUs()
    ...
    filtered_data.to_csv('csvs/us_filtered_data.csv', index=False)

    return filtered_data


def us_filtered_data_with_others():
    data = getUs()
    ...
    filtered_data.to_csv('csvs/us_filtered_data_with_others.csv', index=False)

    return filtered_data


def non_us_filtered_data():
    data = getNonUs()
    ...
    filtered_data.to_csv('csvs/non_us_filtered_data.csv', index=False)

    return filtered_data


def non_us_filtered_data_with_others():
    data = getNonUs()
    ...
    filtered_data.to_csv('csvs/non_us_filtered_data_with_others.csv', index=False)
