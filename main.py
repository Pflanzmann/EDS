...
from salary_increase_percentage_scatter import save_salary_increase_percentage_scatter_plot
...
save_experience_distribution_plot(data, filename, 'Stichproben')
...
save_job_title_distribution_plot(data, filename, 'Stichproben')
...
money_per_experience_full_time_plot(data, filename, 'Stichproben')
...
save_salary_increase_absolut_numbers_line_plot(data, filename, 'Stichproben')
...
save_salary_increase_absolut_numbers_scatter_plot(data, filename, 'Stichproben')
...
save_salary_increase_percentage_lines_plot(data, filename, 'Stichproben')

data = us_filtered_data_with_others()
filename = 'pngs/us_salary_increase_percentage_scatter.png'
save_salary_increase_percentage_scatter_plot(data, filename)

data = non_us_filtered_data_with_others()
filename = 'pngs/non_us_salary_increase_percentage_scatter.png'
save_salary_increase_percentage_scatter_plot(data, filename, 'Stichproben')
